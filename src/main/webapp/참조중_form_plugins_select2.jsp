...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Select2 - Form Plugins - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Select2">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <p class="fs-xs text-muted m-0">
                                            <strong>IE10 Support:</strong> Since this is the latest version of select2 with a customized UI to match SmartAdmin WebApp, some parts of select2 may have issues with IE10. This is due to the limitation of IE10 CSS & Javascript engine, which is currently outdated and has no workaround method. You may use earlier version of select2 and its vanilla skin if select2 is a must have for your list of plugins.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="<%=request.getContextPath()%>/resources/template/js/formplugins/select2/select2.bundle.js"></script>
        <script>
