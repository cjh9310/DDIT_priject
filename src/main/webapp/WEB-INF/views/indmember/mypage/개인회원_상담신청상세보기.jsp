...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
        ...
        <script>
            ...
            {
                console.log("%câ Heads up! Theme settings is empty or does not exist, loading default settings...", "color: #ed1c24");
            }
            ...
            <div class="page-inner">
                ...
                <%-- <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="<%=request.getContextPath()%>/resources/template/img/demo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                ...
                <div class="page-content-wrapper">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    ...
                                    <div class="dropdown-multilevel dropdown-multilevel-left">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="#?lang=fr" class="dropdown-item" data-action="lang" data-lang="fr">FranÃ§ais</a>
                                            <a href="#?lang=en" class="dropdown-item active" data-action="lang" data-lang="en">English (US)</a>
                                            <a href="#?lang=es" class="dropdown-item" data-action="lang" data-lang="es">EspaÃ±ol</a>
                                            <a href="#?lang=ru" class="dropdown-item" data-action="lang" data-lang="ru">Ð ÑÑÑÐºÐ¸Ð¹ ÑÐ·ÑÐº</a>
                                            <a href="#?lang=jp" class="dropdown-item" data-action="lang" data-lang="jp">æ¥æ¬èª</a>
                                            <a href="#?lang=ch" class="dropdown-item" data-action="lang" data-lang="ch">ä¸­æ</a>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item">취업상담</li>
                            <li class="breadcrumb-item active">상담내역 상세보기</li>
                        </ol>
                                            ...
                                            <form>
                                            	<div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control">
                                                        <option selected="">상담유형 선택</option>
                                                        <option value="1">진로상담</option>
                                                        <option value="2">취업상담</option>
                                                        <option value="3">프로그램상담</option>
                                                    </select>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="form-label" for="simpleinput">작성자</label>
                                                    <input type="text" id="example-palaceholder-disabled" class="form-control" placeholder="김땡땡" value="" disabled="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="form-label" for="example-date">상담가능일자 &nbsp;※상담일자를 선택하지않을 경우 상담사가 임의로 연락을 드립니다.</label>
                                                    <input class="form-control" id="example-date" type="date" name="date" value="">
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="form-label" for="example-textarea">상담내용</label>
                                                    <textarea class="form-control" id="example-textarea" rows="7" value=""></textarea>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                 ...
                                                 <div class="card-footer fileInput">
                                                    ...
                                                    <div style="margin-top:30px; text-align:right;">
                                                    	<button type="button" class="btn btn-primary btn-pills waves-effect waves-themed" id="modifyBtn" onclick="modify_go('${notice.nno}');">수 정</button>
														&nbsp;&nbsp;&nbsp;&nbsp;
														<button type="button" class="btn btn-danger btn-pills waves-effect waves-themed" id="removeBtn" onclick="remove_go('${notice.nno}');">삭 제</button>
														&nbsp;&nbsp;&nbsp;&nbsp;
														<button type="button" class="btn btn-warning btn-pills waves-effect waves-themed" id="cancelBtn" onclick="CloseWindow();" >취 소</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
