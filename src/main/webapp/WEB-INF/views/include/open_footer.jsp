<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		...
		<script src="<%=request.getContextPath()%>/resources/template/js/statistics/easypiechart/easypiechart.bundle.js"></script>
		<script src="<%=request.getContextPath()%>/resources/template/js/statistics/chartjs/chartjs.bundle.js"></script>
		<script src="<%=request.getContextPath()%>/resources/template/js/notifications/sweetalert2/sweetalert2.bundle.js"></script>
		<script src="<%=request.getContextPath()%>/resources/template/js/html2canvas.js"></script>
		<script src="<%=request.getContextPath()%>/resources/template/js/jspdf.min.js"></script>
		<script src="<%=request.getContextPath()%>/resources/template/js/datagrid/datatables/datatables.bundle.js"></script>
