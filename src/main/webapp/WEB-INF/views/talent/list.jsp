					...
					<div class="carousel-inner">
						<c:forEach items="${talentList}" var="talent" varStatus="status">
							...
							<div class="card border m-auto m-lg-0">
								<img src="${talent.openLogo}" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title fw-700">${talent.openConm}</h5>
									<p class="card-text">${talent.openTitle}</p>
									<p class="card-text">${talent.openEdate}까지</p>
									<p class="card-text">${talent.openCarnm}
										${talent.openEdunm}</p>
									<p class="card-text">${talent.openRegion}</p>
									<a href="" class="card-link fw-700">${talent.openConm}
										지원하러가기</a>
								</div>
							</div>
						</div>
				...
				<div class="row" id="accordion-talent" name="talent" 
					...
					<c:forEach items="${talentList}" var="talent">
						...
						<div class="panel-content card-wrapper col-2" style="margin: 0px;">
							<div class="card-deck">
								<div
									class="card talent_card border shadow-0 mb-g shadow-sm-hover"
