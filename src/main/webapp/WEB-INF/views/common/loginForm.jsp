...
<head>
<meta charset="utf-8">
<title>Login - Log4Job 대전광역시 취업정보시스템</title>
...
<link rel="stylesheet" media="screen, print"
	href="<%=request.getContextPath()%>/resources/template/css/page-login-alt.css">
</head>
<body>
	<script>
		/**
            ...
            <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
                ...
                <form action="login.do"	method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" class="form-control" placeholder="password" name="pwd" placeholder="패스워드를 입력하세요."  value="">
                        <span class="help-block">
                            Your Password
                        </span>
                    </div>
	...
	<div class="login-footer p-2">
		<div class="row">
			<div class="col col-sm-12 text-center">
				<i>대전광역시 취업정보시스템 - Log4Job에 방문하신것을 환영합니다.</i>
			</div>
		</div>
	</div>
	<video
		poster="<%=request.getContextPath()%>/resources/template/img/backgrounds/clouds.png"
		id="bgvid" playsinline autoplay muted loop>
		<%-- <source src="<%=request.getContextPath()%>/resources/template/media/video/cc.webm" type="video/webm"> --%>
		<source
			src="<%=request.getContextPath()%>/resources/template/media/video/loginFormVideo4k.mp4"
			type="video/mp4">
	</video>
	<!-- BEGIN Color profile -->
