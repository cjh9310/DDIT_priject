					...
					<div>
						<div class="col-xl-12 panel resume-area" style="padding: 0px;">
							<div class="custom-scroll">
								<div class="p-3" id="applicant-resume">
									<table class="table text-center" width="800">
										...
										<tr>
											<td class="border p-0" rowspan="5"
												...
												src="<%=request.getContextPath()%>/member/getPicture.do?id=${member.id}"
												alt="증명사진" /></td>
										</tr>
										<tr>
											<th colspan="3"
										...
										<tr>
											<td colspan="3" class="border">${member.name}</td>
											<td colspan="3" class="border">${member.indBir}</td>
											<td colspan="3" class="border">${member.email}</td>
										</tr>
										<tr>
										...
										<tr>
											<th class="border">${member.tel}</th>
											<td class="border" colspan="8">${member.indAddr}</td>
										</tr>
									</table>
									<div
...
<script
	src="<%=request.getContextPath()%>/resources/template/js/jspdf.min.js">
</script>
<script>
var pdfBtn = document.getElementById('pdfBtn');
pdfBtn.addEventListener("click", function() {
	const pdfArea = document.querySelector('#applicant-resume');
...
/* pdfBtn.addEventListener("click", function() {
		$('#pdfBtn').click(function() { // pdf저장 button id
				const pdfArea = document
						.querySelector('div[name="resume-area"]');
				pdfArea.style.height = pdfArea.scrollHeight + 'px';
