...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Cropper - Form Plugins - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Cropper">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-9">
                                                        ...
                                                        <div class="img-container">
                                                            <img id="image" src="<%=request.getContextPath()%>/resources/template/img/demo/gallery/3.jpg" alt="Picture">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <!-- <h3>Preview:</h3> -->
