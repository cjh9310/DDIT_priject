...
<head>
<meta charset="utf-8">
<title>General Docs - Documentation - SmartAdmin v4.5.1</title>
...
<link rel="stylesheet" media="screen, print"
	href="<%=request.getContextPath()%>/resources/template/css/theme-demo.css">
<link rel="stylesheet" media="screen, print"
	href="<%=request.getContextPath()%>/resources/template/css/fa-duotone.css">
<link rel="stylesheet" media="screen, print"
	href="<%=request.getContextPath()%>/resources/template/css/fa-brands.css">
<style>
	.introduction-content { width: 100%; height: 780px; }
	.ai-content { width: 100%; height: 1050px; }
</style>
</head>
<!-- BEGIN Body -->
<!-- Possible Classes
		...
		<div class="page-inner">
			...
			<aside class="page-sidebar">
				...
				<nav id="js-primary-nav" class="primary-nav" role="navigation">
					...
					<ul id="js-nav-menu" class="nav-menu">
						...
						<li class="active open"><a href="#" title="Documentation"
							...
							<ul>
								<li class="active"><a href="docs_general.html"
									title="General Docs"
						...
						<li><a href="#" title="Form Stuff"
							...
							<ul>
								...
								<li><a href="form_input_groups.html" title="Input Groups"
									data-filter-tags="form stuff input groups"> <span
										class="nav-link-text" data-i18n="nav.form_stuff_input_groups">Input
											Groups</span>
								</a></li>
			...
			<div class="page-content-wrapper">
				...
				<div class="card mb-4">
					<div class="card-body p-4 rounded position-relative">
						<div class="d-flex align-items-center mb-g">
							<img
								src="<%=request.getContextPath()%>/resources/template/img/demo/html5.png"
								class="mr-3">
							<h1 class="fw-300 m-0 l-h-n">
								<span class="text-contrast"> AI Service List </span> <small
									class="fw-300 m-0 l-h-n"> 준비되어있는 AI Service 리스트를 살펴보세요.
								</small>
							</h1>
						</div>
						<div class="row">
							<div class="col-lg-4">
								<ul class="fs-md fw-700 mb-5 list-spaced">
									<li><a href="#AI_SERVICE_1">AI와 함께하는 취업 탐색 - 1</a></li>
								</ul>
							</div>
							<div class="col-lg-4">
								<ul class="fs-md fw-700 mb-5 list-spaced">
									<li><a href="#AI_SERVICE_2">AI와 함께하는 취업 탐색 - 2</a></li>
								</ul>
							</div>
							<div class="col-lg-4">
								<ul class="fs-md fw-700 mb-5 list-spaced">
									<li><a href="#AI_SERVICE_3">AI와 함께하는 취업 탐색 - 3</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="card mb-g p-2">
					<div class="card-body">
						<h2 class="fw-700 m-0">
							Log4job의 AI Service 소개 <a href="javascript:void(0);"></a>
							<small>Introduction to Service in Log4Job</small>
						</h2>
						<div class="introduction-content">
						
						</div>
					</div>
					<target id="AI_SERVICE_1"/>
				</div>
				<div class="card mb-g p-2">
					<div class="card-body">
						<h2 class="fw-700 m-0">
							AI와 함께하는 취업 탐색 - 1 
							<a href="javascript:void(0);"></a><small>AI Service - 1</small>
						</h2>
						<div class="ai-content">
						
						</div>
					</div>
					<target id="AI_SERVICE_2"/>
				</div>
				<div class="card mb-g p-2">
					<div class="card-body">
						<h2 class="fw-700 m-0" name="pluginreference">
							AI와 함께하는 취업 탐색 - 2 <a href="javascript:void(0);" ></a> 
								<small>AI Service - 2</small>
						</h2>
						<div class="ai-content">
						
						</div>
						<target id="AI_SERVICE_3"/>
					</div>
				</div>
				<div class="card mb-g p-2" id="AI_SERVICE_3">
					<div class="card-body">
						<h2 class="fw-700 m-0">
							AI와 함께하는 취업 탐색 - 3 <a href="javascript:void(0);" ></a> 
								<small>AI Service - 3</small>
						</h2>
						<div class="ai-content">
														...
														.each(
																...
																function(index,
																	...
																	$(
																			'.js-plugins')
																			.append(
																					'<option value="' + value.plugin + '" data-description="' + value.description + '" data-url="' + value.url + '" data-license="' + value.license + '">'
																							+ value.plugin
																							+ '</option>');
																});
											});
