...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link " style=”overflow-x:auto;overflow-y:hidden”>
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="<%=request.getContextPath()%>/resources/template/img/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
                            <span class="page-logo-text mr-1">Log4Job</br>취업정보시스템</span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        <div class="nav-filter">
                            <div class="position-relative">
                                <input type="text" id="nav_filter_input" placeholder="메뉴 검색" class="form-control" tabindex="0">
                        ...
                        <div class="info-card">
                            <img src="<%=request.getContextPath() %>/member/getPicture.do?id=${loginUser.id }" class="profile-image rounded-circle" alt="회원사진">
                            <div class="info-card-text">
                                <a href="#" class="d-flex align-items-center text-white">
                                    <span class="text-truncate text-truncate-sm d-inline-block">
                                    	<div class="row">
		         							<a href="javascript:goPage('<%=request.getContextPath()%>/indmember/mypage/info.do','');" class="d-block" >${loginUser.name }</a>&nbsp;&nbsp;
	         							</div>
                                    </span>
                                </a>
                                <span class="d-inline-block text-truncate text-truncate-sm"><a href="tel:${loginUser.phone }">tel : ${loginUser.phone}</a></span>
                                <span class="d-inline-block text-truncate text-truncate-sm"><a href="mailto:${loginUser.email }">email : ${loginUser.email }</a></span>
                            </div>
                            <img src="<%=request.getContextPath()%>/resources/template/img/card-backgrounds/cover-2-lg.png" class="cover" alt="cover">
	                    ...
	                    <sec:authorize access="hasAnyRole('ROLE_ADMIN, ROLE_MANAGER')" >
	                        ...
	                        <ul class="list-table m-auto nav-footer-buttons">
	                            <li>
	                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="관리자 전용 마이페이지">
	                                    <i class="fal fa-life-ring"></i>
	                                    <span class="nav-link-text" data-i18n="nav.application_intel">관리자 전용 마이페이지</span>
	                                </a>
	                            </li>
	                        </ul>
	                    	</div>
                    	...
                    	<sec:authorize access="hasAnyRole('ROLE_USER')" >
	                    	<div class="nav-footer shadow-top">
		                        ...
		                        <ul class="list-table m-auto nav-footer-buttons">
		                            <li>
		                                <a href="javascript:flaskConnect();" data-toggle="tooltip" data-placement="top" title="회원 전용 마이페이지">
		                                    <i class="fal fa-life-ring"></i>
		                                    <span class="nav-link-text" data-i18n="nav.application_intel">회원 전용 마이페이지</span>
		                                </a>
		                            </li>
		                        </ul>
		                    </div>
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                        	<c:forEach items="${menuList }" var="menu">
                            	<li>
	                                <a href="javascript:subMenu_go('${menu.mcode }');goPage('<%=request.getContextPath()%>${menu.murl}','${menu.mcode }');" title="Application Intel" data-filter-tags="application intel">
	                                    <i class="fal fa-cube""></i>
	                                    <span class="nav-link-text" data-i18n="nav.application_intel">${menu.mname}</span>
	                                </a>
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="search">
                            <form class="app-forms hidden-xs-down" role="search" action="page_search.html" autocomplete="off">
                                <input type="text" id="search-field" placeholder="무엇이든 검색해보세요" class="form-control" tabindex="1">
                        ...
                        <div class="ml-auto d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
                                    ...
                                    <div class="custom-scroll h-100">
                                        <ul class="app-list">
                                            ...
                                            <li class="w-100">
                                                <a href="#" class="btn btn-default mt-4 mb-2 pr-5 pl-5"> 바로가기 추가 </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style=""></span>
                                                            </span>
                                                        ...
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            ...
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-2">
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style=""></span>
                                                            ...
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-1">
                                                                    <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                                        <span class="d-block img-share" style=""></span>
                                                                    </a>
                                                                </div>
                                                                <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                                            </div>
                            ...
                            <!-- 마이페이지 -->
                            <div>
                                <a href="#" data-toggle="dropdown" title="마이페이지" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="<%=request.getContextPath() %>/member/getPicture.do?id=${loginUser.id }"  class="profile-image rounded-circle" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<%=request.getContextPath() %>/member/getPicture.do?id=${loginUser.id }" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
                                    ...
                                    <div class="dropdown-multilevel dropdown-multilevel-left">
                                        ...
                                        <sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_MANAGER')" >
	                                        <div class="dropdown-menu myPage-menu">
	                                            <a href="#" class="dropdown-item" >권한 관리</a>
                                        ...
                                        <sec:authorize access="hasAnyRole('ROLE_USER')" >
	                                        <div class="dropdown-menu myPage-menu">
	                                            <a href="javascript:goPage('<%=request.getContextPath()%>/indmember/mypage/info.do','');" class="dropdown-item" >회원정보 관리</a>
	                                            <a href="javascript:goPage('<%=request.getContextPath()%>/indmember/mypage/supply.do','');" class="dropdown-item" >지원내역 관리</a>
	                                            <a href="javascript:goPage('<%=request.getContextPath()%>/indmember/mypage/resume.do','');" class="dropdown-item" >이력서 관리</a>
	                                            <a href="javascript:goPage('<%=request.getContextPath()%>/indmember/mypage/support.do','');" class="dropdown-item" >취업지원 관리</a>
	                                            <a href="javascript:goPage('<%=request.getContextPath()%>/indmember/mypage/usage.do','');" class="dropdown-item"  class="dropdown-item" >서비스 이용내역</a>
	                                        </div>
                                        </sec:authorize>
                                    </div>
                                    </sec:authorize>
                                    ...
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="common/logout.do">
                                        ...
                                        <span class="float-right fw-n">${loginUser.email }</span>
                                    </a>
                                </div>
                            </div>
                            <!-- 마이페이지 -->
                    ...
                    <iframe name="ifr" src="<%=request.getContextPath()%>/main.do" frameborder="0" scrolling=yes style="width:100%;height:100%;">
                        <%-- <div class="row">
                                ...
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        ...
                                        <div class="panel-toolbar">
                                            <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip" data-offset="0,10" data-original-title="접어두기"></button>
                                            <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="풀스크린으로 보기"></button>
                                            <button class="btn btn-panel" data-action="panel-close" data-toggle="tooltip" data-offset="0,10" data-original-title="닫기"></button>
                                        </div>
                                    </div>
                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">2022 © Log4Job - 대전광역시 취업정보시스템</span>
                        </div>
                        <div>
                            <ul class="list-table m-0">
                                <li><a href="intel_introduction.html" class="text-secondary fw-700">고객센터</a></li>
                                <li class="pl-3"><a href="info_app_licensing.html" class="text-secondary fw-700">개인정보취급방침</a></li>
                                <li class="pl-3"><a href="info_app_docs.html" class="text-secondary fw-700">데이터 출처</a></li>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <ul class="app-list w-auto h-auto p-0 text-left">
                                        <li>
                                            <a href="<%=request.getContextPath()%>/index.do" class="app-list-item text-white border-0 m-0">
        ...
        <nav class="shortcut-menu d-none d-sm-block">
            ...
            <a href="common/logout.do" class="menu-item btn" data-toggle="tooltip" data-placement="left" title="로그아웃">
                <i class="fal fa-sign-out"></i>
            </a>
            <a href="#" class="menu-item btn" data-action="app-fullscreen" data-toggle="tooltip" data-placement="left" title="풀스크린">
                <i class="fal fa-expand"></i>
            </a>
            <a href="#" class="menu-item btn" data-action="app-print" data-toggle="tooltip" data-placement="left" title="페이지 인쇄">
                <i class="fal fa-print"></i>
            </a>
            <a href="#" class="menu-item btn" data-action="app-voice" data-toggle="tooltip" data-placement="left" title="AI Service">
            ...
            <div class="modal-dialog modal-dialog-right">
                <div class="modal-content h-100">
                    <div class="dropdown-header bg-trans-gradient d-flex align-items-center w-100">
                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                            <span class="mr-2">
                                <span class="rounded-circle profile-image d-block" style=""></span>
                            </span>
                            <div class="info-card-text">
                                        ...
                                        <li>
                                            <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="tracey chang online">
                                                <div class="d-table-cell align-middle status status-success status-sm ">
                                                    <span class="profile-image-md rounded-circle d-block" style=""></span>
                                                </div>
                    ...
                    <div class="modal-body p-0">
                        <div class="settings-panel">
                            ...
                            <div class="expanded theme-colors pl-5 pr-3">
                                <ul class="m-0">
                                    <li>
                                        <a href="#" id="myapp-0" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/" data-toggle="tooltip" data-placement="top" title="Wisteria (base css)" data-original-title="Wisteria (base css)"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-1" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-1.css" data-toggle="tooltip" data-placement="top" title="Tapestry" data-original-title="Tapestry"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-2" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-2.css" data-toggle="tooltip" data-placement="top" title="Atlantis" data-original-title="Atlantis"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-3" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-3.css" data-toggle="tooltip" data-placement="top" title="Indigo" data-original-title="Indigo"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-4" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-4.css" data-toggle="tooltip" data-placement="top" title="Dodger Blue" data-original-title="Dodger Blue"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-5" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-5.css" data-toggle="tooltip" data-placement="top" title="Tradewind" data-original-title="Tradewind"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-6" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-6.css" data-toggle="tooltip" data-placement="top" title="Cranberry" data-original-title="Cranberry"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-7" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-7.css" data-toggle="tooltip" data-placement="top" title="Oslo Gray" data-original-title="Oslo Gray"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-8" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-8.css" data-toggle="tooltip" data-placement="top" title="Chetwode Blue" data-original-title="Chetwode Blue"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-9" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-9.css" data-toggle="tooltip" data-placement="top" title="Apricot" data-original-title="Apricot"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-10" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-10.css" data-toggle="tooltip" data-placement="top" title="Blue Smoke" data-original-title="Blue Smoke"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-11" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-11.css" data-toggle="tooltip" data-placement="top" title="Green Smoke" data-original-title="Green Smoke"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-12" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-12.css" data-toggle="tooltip" data-placement="top" title="Wild Blue Yonder" data-original-title="Wild Blue Yonder"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-13" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-13.css" data-toggle="tooltip" data-placement="top" title="Emerald" data-original-title="Emerald"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-14" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-14.css" data-toggle="tooltip" data-placement="top" title="Supernova" data-original-title="Supernova"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-15" data-action="theme-update" data-themesave data-theme="<%=request.getContextPath()%>/resources/template/css/themes/cust-theme-15.css" data-toggle="tooltip" data-placement="top" title="Hoki" data-original-title="Hoki"></a>
                                    </li>
                                </ul>
                            </div>
                            <hr class="mb-0 mt-4">
