...
function addFile_go2(limtLen){
	...
	var div=$('<div>').addClass("inputRow").attr("data-no",dataNum1);
	var input=$('<input>').attr({"type":"file","name":"uploadFile"}).css("display","inline");
	
	var button="<button onclick='remove_go("+dataNum1+");' style='border:0;outline:0;' class='badge bg-red' type='button'>X</button>";
