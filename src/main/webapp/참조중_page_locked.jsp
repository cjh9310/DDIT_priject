        ...
        <div class="page-wrapper auth">
            <div class="page-inner bg-brand-gradient">
                <div class="page-content-wrapper bg-transparent m-0">
                    ...
                    <div class="d-flex flex-1" style="background: url(<%=request.getContextPath()%>/resources/template/img/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
                        <div class="container py-4 py-lg-5 my-lg-5 px-4 px-sm-0 text-white d-flex align-items-center justify-content-center">
                            <form id="js-login" role="form" class="text-center text-white mb-5 pb-5" action="intel_analytics_dashboard.html">
                                <div class="py-3">
                                    <img src="<%=request.getContextPath()%>/resources/template/img/demo/avatars/avatar-admin-lg.png" class="img-responsive rounded-circle img-thumbnail" alt="thumbnail">
                                </div>
